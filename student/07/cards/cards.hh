...
class Cards {
    ...
    private:
      ...
      int recursive_print_reverse(Card_data* top, std::ostream& s);
      void recursive_print(Card_data* top, std::ostream& s);// You can use this function in the implementation of method print_from_bottom_to_top.
      Card_data* top_;
};
